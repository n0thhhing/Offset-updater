...
console.log(color.Red(`Nested ${color.Green('color')} text`));
console.log(color.bg.Blue(color.Red('Blue background')));
console.log(color.Bold('Bold text'));
console.log(color.rgb(255, 0, 0)('Red text using RGB'));
console.log(color.hex('#FF0000')('Red text using HEX'));
console.log(color.bg.rgb(255, 0, 0)('Red background using RGB'));
console.log(color.bg.hex('#FF0000')('Red background using HEX'));
console.log(color.Yellow('Yellow text'));
console.log(color.bg.Green(color.Yellow('Green background')));
console.log(color.Italic('Italic text'));
console.log(color.rgb(0, 255, 255)('Cyan text using RGB'));
console.log(color.hex('#00FFFF')('Cyan text using HEX'));
console.log(color.bg.rgb(0, 255, 255)('Cyan background using RGB'));
console.log(color.bg.hex('#00FFFF')('Cyan background using HEX'));
console.log(color.BrightRed(color.Underline('Bright Red text with underline')));
console.log(
  color.bg.BrightYellow(color.Italic('Bright Yellow background with italic')),
);
console.log(color.Bold('Bold text with default foreground color'));
console.log(
  color.bg.DarkGray(color.Underline('Dark Gray background with underline')),
);
console.log(color.BrightBlue(color.Reverse('Bright Blue text with reverse')));
try {
  console.log(color.hex('#GHIJKL')('Invalid HEX'));
} catch (error) {
